                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class=" d-flex gap-1">
                              {{-- <a class="btn btn-danger btn-xs" type="button" href="{{ route('admin.vehicule.destroy',['vehicule'=>$vehicule->id]) }}" data-original-title="btn btn-danger btn-xs" title="">Delete</a> --}}
