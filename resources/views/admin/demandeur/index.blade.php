                ...
                <div class="card">
                  <div class="card-header pb-0">
                    ...
                    <div class="form-group text-end mb-5">
                      <a class="btn btn-primary " type="button" href="{{ route('admin.demandeur.create') }}" >Ajouter un demandeur</a>
                    </div>
                  </div>
                          ...
                          <tr>
                            ...
                            <td class=" d-flex gap-1">
                              ...
                              <form action="{{ route('admin.demandeur.destroy',['demandeur'=>$demandeur->id]) }}" method="POST"> 
                                @csrf
                                @method('delete')
                                <button type="submit" style="font-size: 0.71rem" class="btn btn-danger btn-xs text-xs" onclick='return confirm("Etes vous sûr de vouloir supprimer ce demandeur ?")' title="">Supprimer</button>
                            </form>
